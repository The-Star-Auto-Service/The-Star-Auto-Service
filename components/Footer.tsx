  ...
  return (
    <footer style={{ background:"linear-gradient(180deg,#000,#0a0e27)", color:"white", padding:"3rem 1rem", marginTop:40 }}>
      <div className="container" style={{ textAlign:"center" }}>
        <div style={{ color:"var(--accent-yellow)", fontWeight:900, fontSize:"1.6rem", letterSpacing:2, marginBottom:16 }}>
          ★ The Star Auto Service
        </div>
        <div style={{ display:"flex", gap:"2rem", justifyContent:"center", marginBottom:16 }}>
          <Link href="/" style={a}>Home</Link>
          <Link href="/services" style={a}>Services</Link>
          <Link href="/about" style={a}>About</Link>
